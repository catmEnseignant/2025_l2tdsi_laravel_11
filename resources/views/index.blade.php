          ...
          <div class="col-12">
            <div class="certifications">
              ...
              <div class="certification-item" data-aos="zoom-in" data-aos-delay="1000">
                <img src="{{ asset("assets/js/main.js") }}" alt="Certification">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="department-card">
              <div class="department-image">
                <img src="{{ asset("assets/js/main.js") }}" alt="Cardiology Department" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="department-card">
              <div class="department-image">
                <img src="zz" alt="Pediatrics Department" class="img-fluid">
              </div>
              <div class="department-content">
                <div class="department-icon">
